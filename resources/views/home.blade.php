        ...
        <div class="col-md-10">
            <div class="card shadow ">
                ...
                <div class="card-header text-center">
                   <h2> <strong> JCSA 2021: IV Jornadas de Calidad de Software y Agilidad </strong> </h2> <br>
                   <h3 class="text-muted">Ciudad de Corrientes, Argentina, Noviembre 12 y 13, 2021 </h3>
                </div>
            </div>
        </div>
    </div>
